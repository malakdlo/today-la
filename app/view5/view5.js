...
.controller('getstartedCtrl', function($scope, EventsFactory) {

  $scope.searchRandom = EventsFactory.searchRandom;
  $scope.clearRandomSearch = EventsFactory.clearRandomSearch;
})
.factory('EventsFactory', function(){
  var EventsFactory = this;
  
  /* DATA */
  EventsFactory.results = [
   {
      "name":"Example 1",
  ...
  /** SEARCH RANDOM **/
  EventsFactory.searchRandom = function(){
    if(EventsFactory.results){
      console.log("Able to read EventsFactory.results")
      var randomNum = EventsFactory.getRandomInt(0, EventsFactory.results.length);
      console.log("Will search for event number: " , randomNum);
      var randomEventLink = EventsFactory.results[randomNum].link;
      var randomEventTitle = EventsFactory.results[randomNum].name;
      var randomEventDetails = EventsFactory.results[randomNum].details;
  ...
  EventsFactory.clearRandomSearch = function(){
  ...
  /* HELPER FUNCTIONS */
  EventsFactory.getRandomInt = function(min, max){
